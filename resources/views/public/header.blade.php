    ...
    <div class="container collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu shadow bg-lime" aria-labelledby="navbarDropdown">
            ...
            <li class="nav-item">
                <a class="nav-link" href="./tempat_wisata">TEMPAT WISATA</a>
            </li>
        </ul>
        <form class="form-inline my-0 my-lg-0">
            <div class="input-group">
                <input class="form-control bg-dark text-light border-0 col-xl-12" type="search" placeholder="Cari..." aria-label="Cari">
