...
@section('tab')
Hasil pencarian - KHDTK Samboja
@endsection

@section('title')
<h1><b>HASIL PENCARIAN UNTUK {{ $search }}</b></h1>
<hr class="bg-dark">
@endsection
...
<div class="text-justify">
    {!! $post->deskripsi !!}
    @include('public.tempat_wisata.list')
</div>
@endsection
...
<a href=" {{ route('public.wisata.gallery') }}" class="btn btn-primary text-uppercase d-flex justify-content-center">Lihat Semua</a>
